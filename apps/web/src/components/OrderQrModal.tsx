...
const modal: React.CSSProperties = { background: "var(--bg)", borderRadius: 22, width: 428, maxWidth: "100%", maxHeight: "calc(92vh / var(--ui-scale))", overflowY: "auto", boxShadow: "0 24px 70px -18px rgba(28,26,23,0.4), 0 2px 8px rgba(28,26,23,0.08)", overflowX: "hidden" };

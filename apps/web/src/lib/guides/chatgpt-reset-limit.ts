...
const chatgptResetLimit: Guide = {
  ...
  content: {
    ...
    en: {
      eyebrow: "Guide · 2 ways",
      title: "How to reset your ChatGPT usage limit",
      intro:
        "When an account hits the 5-hour limit or the weekly limit, you can spend one **reset** to put usage back to 100%. Each reset can be used only once a month.",
      sections: [
        {
          heading: "Way 1 — On the web at chatgpt.com",
          steps: [
            {
              title: "Open the account menu",
              body: "In the bottom left corner, click your plan or workspace name to open the menu, then choose **Settings**.",
              image: webMenu,
              imageAlt: "Account menu in the sidebar",
              caption: "Sidebar → account menu → Settings",
            },
            {
              title: "Go to the Settings window",
              body: "The settings window opens on the **General** tab. The list of sections sits in the left column.",
              image: webSettings,
              imageAlt: "Settings window, General tab",
              caption: "Settings → General",
              imageMaxWidth: 820,
            },
            {
              title: "Click “Use reset”",
              body: "Open **Usage** in the left column. When a reset is available it appears as a card — for example **Full reset (Weekly + 5 hr)** with its expiry date — and a **Use reset** button on the right. Click that button.",
              image: webUseReset,
              imageAlt: "Full reset card with the Use reset button",
              caption: "Usage limit resets → Use reset",
              imageMaxWidth: 940,
            },
            {
              title: "Confirm the reset",
              body: "A confirmation dialog appears. Click **Use reset** to spend it now, or **Save for later** to keep it. Once confirmed, both the weekly limit and the 5-hour limit go back to 100%.",
              image: webConfirm,
              imageAlt: "Confirmation dialog for resetting usage limits",
              caption: "“Do you want to reset your usage limits?” → Use reset",
              imageMaxWidth: 900,
            },
          ],
        ...
        {
          heading: "Way 2 — In the Codex app",
          steps: [
            {
              title: "Open the account menu in the bottom left",
              body: "In the Codex app, click your plan name at the bottom of the sidebar to open the account menu.",
              image: codexMenu,
              imageAlt: "Codex app with the account menu open in the bottom left",
              caption: "Codex sidebar → account menu",
            },
            {
              title: "Choose “Usage remaining”",
              body: "Click the **Usage remaining** line to expand what you have left.",
              image: codexUsage,
              imageAlt: "Codex account menu with Usage remaining selected",
              caption: "Menu → Usage remaining",
              imageMaxWidth: 520,
            },
            {
              title: "Click “1 available reset”",
              body: "The menu shows what is left of the 5-hour limit and the weekly limit. If you have a reset, the line **1 available reset** appears — click it.",
              image: codexAvailable,
              imageAlt: "Expanded menu showing 1 available reset",
              caption: "Usage remaining → 1 available reset",
              imageMaxWidth: 430,
            },
            {
              title: "Click “Use reset” in the Usage window",
              body: "The **Usage** window opens with a green **1 available** tag. Click **Use reset** on the Full reset (Weekly + 5 hr) card.",
              image: codexUseReset,
              imageAlt: "Usage window with the Use reset button",
              caption: "Usage limit resets → Use reset",
              imageMaxWidth: 820,
            },
            {
              title: "Click “Confirm” to finish",
              body: "The button turns into **Confirm**. Click once more to commit — both limits return to 100% and the reset is spent.",
              image: codexConfirm,
              imageAlt: "Usage window with the Confirm button",
              caption: "Use reset → Confirm",
              imageMaxWidth: 820,
            },
          ],
      ...
      notes: [
        "Each reset **can be used once a month** and has an expiry date.",
        "If the “Usage limit resets” section is empty, you have none right now — wait until the limits reset on their own at the time shown.",
        "This limit is shared by Codex, Work, Agent and ChatGPT for Excel; ordinary conversations do not count towards it.",
      ],
    },
    "zh-CN": {
      eyebrow: "使用指南 · 2 种方法",
